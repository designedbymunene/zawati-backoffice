...
const PermissionPage = () => {
  ...
  const { isPending, isError, data, error, isSuccess } = useFetchPermissions();
  ...
  return (
    <>
      ...
      >
        ...
        <TableBody
          items={isSuccess ? (data as Permissions[]) : isError ? [] : []}
          isLoading={isPending}
          emptyContent={isError ? error.message : "No Permissions found"}
