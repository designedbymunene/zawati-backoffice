  ...
  return (
    <>
      ...
      >
        ...
        <TableBody
          items={
            loanInstallmentQuery.isSuccess
              ? (loanInstallmentQuery?.data as LoanInstallmentType[])
              : loanInstallmentQuery?.isError
              ? []
              : []
          }
          isLoading={loanInstallmentQuery.isPending}
          emptyContent={
            loanInstallmentQuery.isError
              ? loanInstallmentQuery?.error.message
              : "No members found"
          }
